class MembrosController < ApplicationController
  ...
  private
    ...
    def membro_params
      params.require(:membro).permit(:nome, :sobrenome, :telefone, :endereco, :bairro, :cidade, :data_nascimento, :email, :data_alianca, :data_batismo, :data_desligamento, :observacoes, :situacao)
    end
end
