class AgendasController < ApplicationController
  ...
  def index
    @agendas = Agenda.where('datahora_inicio >= ?', Time.now).order(:datahora_inicio)
  end
  ...
  private
    ...
    def agenda_params
      params.require(:agenda).permit(:titulo, :descricao, :datahora_inicio, :datahora_termino, :vagas, :valor, :link_inscricao, :imagem)
    end
end
