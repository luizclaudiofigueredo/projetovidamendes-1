class TipoEventosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo_evento.save
        format.html { redirect_to tipo_evento_url(@tipo_evento), notice: "Tipo evento was successfully created." }
  ...
  def update
    respond_to do |format|
      if @tipo_evento.update(tipo_evento_params)
        format.html { redirect_to tipo_evento_url(@tipo_evento), notice: "Tipo evento was successfully updated." }
