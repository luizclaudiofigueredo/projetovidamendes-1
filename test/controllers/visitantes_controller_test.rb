...
class VisitantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitante" do
    assert_difference("Visitante.count") do
      post visitantes_url, params: { visitante: { grupo: @visitante.grupo, nome: @visitante.nome, observacoes: @visitante.observacoes, sobrenome: @visitante.sobrenome, telefone: @visitante.telefone } }
    end
  ...
  test "should update visitante" do
    patch visitante_url(@visitante), params: { visitante: { grupo: @visitante.grupo, nome: @visitante.nome, observacoes: @visitante.observacoes, sobrenome: @visitante.sobrenome, telefone: @visitante.telefone } }
