...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference("Pessoa.count") do
      post pessoas_url, params: { pessoa: { bairro: @pessoa.bairro, cep: @pessoa.cep, cidade: @pessoa.cidade, data_nascimento: @pessoa.data_nascimento, email: @pessoa.email, endereco: @pessoa.endereco, estado: @pessoa.estado, nome: @pessoa.nome, nome_mae: @pessoa.nome_mae, nome_pai: @pessoa.nome_pai, sobrenome: @pessoa.sobrenome, telefone: @pessoa.telefone } }
    end
